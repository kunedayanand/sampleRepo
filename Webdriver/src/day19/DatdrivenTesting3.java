...
public class DatdrivenTesting3 {
	...
	{
		FileInputStream f=new FileInputStream("D:\\Alok\\April27batch-master\\Webdriver\\src\\com\\qedge\\excelfiles\\Ajaxdata.xlsx");
		...
		while(row.hasNext())
		{
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("//*[@id='ns_Z7_JH56H4K0KOIPA0ASI08BTI30O5_amountPaid']")).click();
		...
		FileOutputStream f1=new FileOutputStream("D:\\Alok\\April27batch-master\\Webdriver\\src\\com\\qedge\\excelfiles\\Ajaxdata.xlsx");
		wb.write(f1);
		f1.close();
